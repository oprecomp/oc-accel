...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__dieres

#else
#  define SWIG_init    init_dieres

#endif
#define SWIG_name    "_dieres"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_mmult(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:mmult",&obj0,&obj1,&obj2)) SWIG_fail;
  {
    npy_intp size[1] = {
      -1 
    };
  ...
  result = (int)mmult(arg1,arg2,arg3,arg4,arg5,arg6);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"mmult", _wrap_mmult, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
